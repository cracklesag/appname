        ...
        {isSeed ? (
          <div style={{ background: 'var(--forest-soft)', border: '1px solid var(--line)', borderRadius: 8, padding: 13 }}>
            <div style={{ fontSize: 13, color: 'var(--ink-soft)', lineHeight: 1.5 }}>
              ...
              your ground, make your own editable copy.
            </div>
            <form action={forkCrop} style={{ marginTop: 10 }}>
              <input type="hidden" name="crop_id" value={crop.id} />
              <button type="submit" className="btn-primary" style={{ width: '100%' }}>Copy to an editable crop</button>
            </form>
          </div>
        ) : (
          <form action={updateCrop} style={{ background: 'var(--card)', border: '1px solid var(--line)', borderRadius: 8, padding: 14 }}>
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 12 }}>
              ...
              <div style={{ flex: 1.3 }}>
                <label style={lbl}>P/K regime</label>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <div style={{ flex: 2 }}>
                <label style={lbl}>pH note <span style={{ fontWeight: 400 }}>(opt)</span></label>
                <input name="ph_note" defaultValue={p.phNote ?? ''} style={inp} />
              </div>
            </div>
            <label style={{ ...lbl, marginTop: 12 }}>Soil fit</label>
            ...
            <div style={{ fontSize: 11, color: 'var(--muted)', lineHeight: 1.5, marginTop: 14, background: 'var(--paper-deep, #f4efe2)', borderRadius: 6, padding: '8px 10px' }}>
              The nitrogen stage timings and micronutrient notes are carried from the crop you copied and aren&apos;t edited
              here — the figures above drive the plan&apos;s rates.
            </div>
